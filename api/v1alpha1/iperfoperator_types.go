...
// IPerfOperator is the Schema for the iperfoperators API
type IPerfOperator struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`

	Spec   IPerfOperatorSpec   `json:"spec,omitempty"`
	Status IPerfOperatorStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// IPerfOperatorList contains a list of IPerfOperator
type IPerfOperatorList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []IPerfOperator `json:"items"`
}

func init() {
	SchemeBuilder.Register(&IPerfOperator{}, &IPerfOperatorList{})
}
